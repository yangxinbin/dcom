...
public class SmartChangeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private OnChangeClickListener mOnChangeClickListener;//自注册的接口给调用者用于点击逻辑
    private List<ListChangeBean> mData = new ArrayList<>();
    ...
    public SmartChangeAdapter(Context context) {
